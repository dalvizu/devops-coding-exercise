...
Basically, implement this function: [App#get_jira_tickets()](https://github.com/dalvizu/devops-coding-exercise/blob/master/jiratools/app.py#L17)
...
This method and the supporting domain objects have been provided in the `jiratools/` folder, which follows
...
If you have any questions, feel free to ask through your contact. You'll be asked to present your 
